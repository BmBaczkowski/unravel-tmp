...
plot_func <- function(rho_means, rho_hpdi, OR_means, OR_hpdi, rho_betas_rope, title, gr = '1', ylim=c(0.3, .85)) {
    ...
    title(ylab=expression(paste("Memory recognition (", rho, ")")), line=2)
    ...
    text(x=1.5, y=yv + 1.5 * strheight("P"), pos=3, cex = cex_labels, labels = paste0(
            "OR = ", 
            round(OR_means[4], 2), 
            " [", 
            round(OR_hpdi[1,4], 2), 
    ...
    text(x=3.5, y=yv + 1.5 * strheight("P"), pos=3, cex = cex_labels, labels = paste0(
            "OR = ", 
            round(OR_means[5], 2), 
            " [", 
            round(OR_hpdi[1,5], 2), 
    ...
    text(x=5.5, y=yv + 1.5 * strheight("P"), pos=3, cex = cex_labels, labels = paste0(
            "OR = ", 
            round(OR_means[6], 2), 
            " [", 
            round(OR_hpdi[1,6], 2), 
