...
sidecar_list <- list(
  ...
  Description = list(
    panel_a = unbox("Depicts posterior estimates of memory recognition (rho parameter) derived from beta weights; square brackets indicate 89% HPD interval of odds ratio (OR); Pr(ROPE) indicates the proportion of the posterior falling inside the region of practical equivalence, which is +/-0.18 on the log-odds scale"),
