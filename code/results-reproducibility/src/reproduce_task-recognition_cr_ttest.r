...
# Reproduce paired t tests with corrected recognition scores.
...
result <- reproduce_ttest_func(df)

write(json_sidecar, file = json_sidecar_file)
saveRDS(result$ttest, file = rds_target_file)
